...
public class MetalPistolEmitterController : MonoBehaviour, IProjectileEmitterController {
	...
	public void StartEmitting(Properties properties) {
		...
		projectileObject.name = "MetalPistolProjectile";
	...
	public void StopEmitting() {
		// No op for Metal Pistol emitter
	}
}
